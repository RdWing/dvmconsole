...
// decoded by managed adapters. Unsupported formats are rejected rather than
// delegated to an external process, keeping decoding deterministic and
// available on sandboxed hosts.
        ...
        try
        {
            ...
            else
            {
                throw new NotSupportedException(
                    "Only PCM WAV, MPEG/MP3, and Ogg Opus audio streams are supported.");
            }
