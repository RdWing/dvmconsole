...
/// <summary>
/// Binds one immutable application system descriptor to the concrete
/// FNE implementation. Secrets remain in the host-owned connection options and
/// are deliberately excluded from the descriptor.
/// </summary>
public sealed class FneRadioSessionFactory : IFneRadioSessionFactory, IRadioSessionFactory
{
