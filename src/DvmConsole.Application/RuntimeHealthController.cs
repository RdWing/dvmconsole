...
internal sealed class RuntimeHealthController
{
    ...
    private CatalogScanHealth? recordingCatalog;
    ...
    public RuntimeHealthSnapshot Capture(RuntimeHealthCaptureInput input)
    {
        ...
        return new RuntimeHealthSnapshot(
            ...
            recordingFinalization is null ? null : new WorkBacklogHealth(
                observedFinalization.PendingJobs,
                finalizationPeak,
    ...
    public void ObserveRecordingCatalog(CatalogScanHealth health)
    {
    ...
    {
        if (recordingFinalization is null) return finalization;
