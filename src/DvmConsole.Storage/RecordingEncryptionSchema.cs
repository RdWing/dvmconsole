...
public static class RecordingEncryptionSchema
{
    ...
    public static EncryptionSnapshot FromMetadata(CallRecordingMetadata metadata)
    {
        ...
        RadioMediaProtocol protocol = EncryptionProtocolLabels.ParseProtocol(metadata.Protocol);
        byte? algorithmId = metadata.EncryptionAlgorithmId;
        if (algorithmId is null &&
            EncryptionProtocolLabels.TryParseAlgorithmAbbreviation(
                protocol,
        ...
        RadioMediaProtocol protocol)
    {
        ...
        metadata.EncryptionAlgorithm = encryption.IsSecure
            ? EncryptionProtocolLabels.AlgorithmDisplayName(protocol, encryption.AlgorithmId)
            : string.Empty;
