...
public sealed class NeutralSnapSlider : Slider
{
    ...
    private bool isKeyboardInteraction;
    ...
    public event EventHandler? OperatorValueChanged;
    ...
    protected override void OnPropertyChanged(AvaloniaPropertyChangedEventArgs change)
    {
        ...
        if (change.Property != ValueProperty || isApplyingSnap ||
            (!isPointerInteraction && !isKeyboardInteraction))
        {
            return;
        }
        ...
        if (isPointerInteraction)
            SnapPointerValue();
        OperatorValueChanged?.Invoke(this, EventArgs.Empty);
    }
