    ...
    DateTimeOffset? EndDate = null)
{
    ...
    public bool Matches(IHistoryCatalogFilterItem entry)
    {
        ...
        if (!MatchesText(System, entry.SystemName) ||
            ...
            !MatchesEitherText(Alias, entry.CallerText, entry.RecordingSubscriberAlias))
        {
            return false;
        }
        ...
        return SearchTextMatcher.MatchesAllTerms(
            ...
            entry.RecordingRouteText,
            entry.RecordingSubscriberAlias);
    }
