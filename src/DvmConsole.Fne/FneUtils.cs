...
namespace fnecore
{
    // Root-owned mirror of the pinned upstream utility. Keeping this source in
    // the adapter assembly avoids a private submodule fork while replacing its
    // runtime-generated Memset and allocation-heavy primitive conversions with
    // AOT-safe framework operations.
    /// <summary>
    ///
    /// </summary>
    public class FneUtils
    {
        ...
        */
        ...
        {
            array.AsSpan(0, length).Fill(what);
        }
