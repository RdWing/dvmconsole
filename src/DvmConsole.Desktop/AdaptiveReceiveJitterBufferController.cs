...
internal sealed class AdaptiveReceiveJitterBufferController
{
        ...
        ReceiveJitterBufferConfiguration configuration)
    {
        ...
        {
            connection = new ConnectionEstimator();
    ...
    {
        private readonly Dictionary<FneTrafficProtocol, ProtocolEstimator> protocols = [];
            ...
            ReceiveJitterBufferConfiguration configuration)
        {
            ...
            {
                estimator = new ProtocolEstimator(configuration);
    ...
    private sealed class ProtocolEstimator
    {
        ...
        public ProtocolEstimator(ReceiveJitterBufferConfiguration configuration)
        {
    ...
    private sealed class StreamDelayObservation
    {
        ...
        public bool HasRestarted(long arrivalTimestamp, TimeSpan restartGap)
            => arrivalTimestamp > LastArrivalTimestamp &&
               Stopwatch.GetElapsedTime(LastArrivalTimestamp, arrivalTimestamp) >= restartGap;
